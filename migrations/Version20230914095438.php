 ...
 */
final class Version20230914095438 extends AbstractMigration
{
    public function getDescription(): string
    {
        return '[User] Add birthdate column.';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE user ADD COLUMN birthdate DATE DEFAULT NULL');
    }
